export default function Home() {
  return (
    <div className="relative w-full h-screen flex items-center justify-center">
      ...
      {/* Main content */}
      <div className="relative w-[640px] h-[232px] p-8 border border-gray-700/20 bg-[rgba(3,3,3,1)] backdrop-blur-2xl backdrop-saturate-200 backdrop-opacity-80 dark:border-neutral-800 dark:bg-zinc-800/30 flex flex-col justify-center">
